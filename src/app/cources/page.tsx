...
function page() {
  return (
    <div className="min-h-screen bg-black py-12 pt-36">
       <h1 className="text-lg md:text-7xl text-center font-bold mb-8 text-white"> ALL COURCES ({courceData.cources.length})</h1>
       <div className="flex flex-wrap justify-center">
        {courceData.cources.map((cource) => (
          <CardContainer key={cource.id} className="inter-var m-4">
